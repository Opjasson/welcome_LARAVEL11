<x-layout>
            ...
            <form>
                ...
                <div class="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                    <div class="relative w-full">
                        <label for="search"
                            class="hidden mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Find your articels</label>
                        ...
                        <input
                            ...
                            placeholder="Search your articel" type="search" id="search"   
    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
        {{ $posts->links() }}
        <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3 my-5">
